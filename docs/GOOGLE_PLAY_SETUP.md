...
3. 다음 URL로 직접 이동: `https://console.developers.google.com/apis/api/androidpublisher.googleapis.com/overview?project=[YOUR_PROJECT_ID]`
   - `[YOUR_PROJECT_ID]`는 오류 메시지나 서비스 계정 JSON의 `project_id`에서 확인
4. **"사용 설정"** (Enable) 버튼 클릭
5. 2-5분 대기 후 다시 업로드 시도
...
- **Google Play Console**: 앱 대시보드 → **앱 정보** → **앱 ID** 또는 **Package name**
- **프로젝트**: `android/app/build.gradle.kts`의 `applicationId` 확인
